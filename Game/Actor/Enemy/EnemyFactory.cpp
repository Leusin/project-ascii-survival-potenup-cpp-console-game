	...
	, nullPos(Engine::Get().ScreenCenter())
{
	...
	enemyStatsMap[EnemyType::Bat] = { "b", Color::LightBlue, 5.5f, 3.5f, 0.2f, 1.0f };
	enemyStatsMap[EnemyType::Slime] = { "s", Color::Green, 8.0f, 2.8f, 0.4f, 2.0f };
	enemyStatsMap[EnemyType::Goblin] = { "g", Color::Yellow, 10.0f, 4.0f, 0.6f, 3.0f };
	enemyStatsMap[EnemyType::Golem] = { "G", Color::Blue, 20.0f, 4.0f, 0.5f, 4.0f };
	enemyStatsMap[EnemyType::Mumak] = { "M", Color::Yellow, 35.0f, 1.5f, 0.8f, 5.f };
	enemyStatsMap[EnemyType::EpicKnight] = { "K", Color::LightMagenta, 100.0f, 4.5f, 1.0f, 15.0f };
};
